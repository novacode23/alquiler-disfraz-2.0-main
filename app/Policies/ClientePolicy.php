...
class ClientePolicy
{
    ...
    {
        return $user->checkPermissionTo('delete-any Cliente');
    }
    ...
    {
        return $user->checkPermissionTo('restore-any Cliente');
    }
    ...
    {
        return $user->checkPermissionTo('replicate Cliente');
    }
    ...
    {
        return $user->checkPermissionTo('reorder Cliente');
    }
    ...
    {
        return $user->checkPermissionTo('force-delete-any Cliente');
    }
}
